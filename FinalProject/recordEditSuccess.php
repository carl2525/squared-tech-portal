...
<body>
  ...
  <form method="post" action="register.php">
    ...
    <hr>
     <button onclick="document.location.href ='addRecordData.php' " type="button" class="registerbtn" name="reg_user">Go Back to View Add Record User Data Table Forms</button>
