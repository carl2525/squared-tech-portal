...
if ($conn->query($sql) === TRUE) {
  $outputTable = " The user Table created successfully";
} else {
...
<body>
  ...
  <form method="post" action="register.php">
	...
	<p><?php echo $outputTable?></p>
      ...
      <button onclick="document.location.href ='homepage.php' " type="button" class="registerbtn" name="clr_user">Go Back to User Homepage</button>
